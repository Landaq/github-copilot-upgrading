...
class TestConfigOptions(unittest.TestCase):
    ...
    def test_options_from_file_empty_options(self):
        ...
        opt = DictMatch('/tmp/guachi/conf_nine.ini',
                        self.mapped_options, self.mapped_defaults)
        actual = opt.options()
        expected = self.mapped_defaults
        self.assertEqual(actual, expected)
    ...
    def test_options_from_file_one_option(self):
        ...
        opt = DictMatch('/tmp/guachi/conf_eight.ini',
                        self.mapped_options, self.mapped_defaults)
        actual = opt.options()
        expected = {
            'db_host': 'example.com',
    ...
    def test_options_key_error_passes(self):
        ...
        opt = DictMatch('/tmp/guachi/conf_seven.ini',
                        self.mapped_options, self.mapped_defaults)
        actual = opt.options()
        expected = {
